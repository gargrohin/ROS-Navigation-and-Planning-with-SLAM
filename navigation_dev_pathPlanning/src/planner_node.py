...
WAYPOINTS = [[0.4250000000000001, 0.35,0], [0.37500000000000006, -0.04999999999999999,0], 
[0.3875, -0.07500000000000001,0], [0.40735294117647064, -0.39264705882352935,0], 
[0.75, -0.5795454545454546,0], [1.0, -0.48863636363636365,0], [1.25, -0.5795454545454546,0], 
[1.5926470588235295, -0.39264705882352935,0], [1.6125, -0.07499999999999998,0],[1.58 ,0.35,0]]
...
if __name__ == "__main__":
    ...
    count = 0
    while current_destination < len(WAYPOINTS) and abs(getDistance(x,y,dest_x,dest_y)) > 0.07:
        print(current_pose)
